...
- **Waktu:** 2026-09-24 14:11:56
- **Mode:** `default`  ·  **Durasi total:** 233s  ·  **Pekerja statik:** 2
...
| guard:create_modal SELF-TEST (bukti-merah penjaga create pop-up) | PASS (1s) |
...
| guard:detail_modal (INV-UI-08, panel rincian wajib pop-up) | PASS (2s) |
...
| guard:to_list_bound SELF-TEST (bukti-merah dua arah, 11 kasus) | PASS (1s) |
...
| POC FASE E-7 (pagar entitas grup · HPP taksiran berlabel · permintaan internal · kas grup dihapus · pinjaman & pindah aset antar-PT) | PASS (5s) |
...
| audit_sales_roles_ux SELF-TEST (bukti-merah penilaian layar mati) | PASS (1s) |
