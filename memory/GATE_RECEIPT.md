...
- **Waktu:** 2026-09-24 15:04:13
- **Mode:** `default`  ·  **Durasi total:** 231s  ·  **Pekerja statik:** 2
...
| guard:home_kpi SELF-TEST (bukti-merah penjaga KPI beranda) | PASS (1s) |
...
| POC Papan PO Custom (umur tunggu bukan tebakan · yang tertua ikut · jujur saat dipotong · nol residu) | PASS (1s) |
...
| guard:master_stages SELF-TEST (bukti-merah tahapan proses, 20 kasus dua arah) | PASS (1s) |
