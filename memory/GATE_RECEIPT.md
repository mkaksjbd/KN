...
- **Waktu:** 2026-09-24 14:54:05
- **Mode:** `default`  ·  **Durasi total:** 235s  ·  **Pekerja statik:** 2
...
| guard:picker_portal (INV-UI-09, pemilih wajib ber-portal · pop-up bukan anak <label>) | PASS (8s) |
| guard:escape_layers SELF-TEST (bukti-merah + anti tuduh palsu, 13 kasus) | PASS (1s) |
| guard:escape_layers (INV-UI-10, Esc menutup lapisan teratas saja) | PASS (2s) |
...
| guard:codebase_map SELF-TEST (bukti-merah dua arah, 6 kasus) | PASS (3s) |
| guard:codebase_map (INV-DOC-01, CODEBASE_MAP.md selaras kode) | PASS (2s) |
...
| config_wiring SELF-TEST (bukti-merah guardrail) | PASS (18s) |
...
| guard:roll_identity (INV-ROLL-01, satu nomor untuk satu roll) | PASS (6s) |
...
| audit_entity_isolation (E0.9/E0.10 — 0 kebocoran lintas-entitas) | PASS (10s) |
...
| audit_sales_roles_ux (SEMUA peran: nol layar & panel mati) | PASS (50s) |
...
| guard:doc_origin SELF-TEST (bukti-merah asal dokumen PO, 26 kasus dua arah) | PASS (1s) |
...
| POC FASE I (inspeksi & QC: SPK otomatis · grade dari mesin lama · tahanan warna dilepas manajer · nol residu) | PASS (11s) |
