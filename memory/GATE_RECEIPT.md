...
| config_wiring SELF-TEST (bukti-merah guardrail) | PASS (16s) |
...
| audit_entity_isolation (E0.9/E0.10 — 0 kebocoran lintas-entitas) | PASS (9s) |
...
| guard:po_board SELF-TEST (bukti-merah papan PO, 22 kasus dua arah) | PASS (1s) |
...
| POC FASE I (inspeksi & QC: SPK otomatis · grade dari mesin lama · tahanan warna dilepas manajer · nol residu) | PASS (9s) |
