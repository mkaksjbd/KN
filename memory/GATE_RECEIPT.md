...
- **Waktu:** 2026-09-24 13:33:32
- **Mode:** `full`  ·  **Durasi total:** 391s  ·  **Pekerja statik:** 2
...
| guard:warehouse_scope SELF-TEST (E4.1, gudang khusus badan usaha) | PASS (2s) |
...
| audit_sales_roles_ux (SEMUA peran: nol layar & panel mati) | PASS (51s) |
...
| guard:uom_vocab (INV-UOM-02, satuan dokumen ⊆ master uoms · alias tak kembar · pemilih satuan dari master) | PASS (2s) |
...
| POC FASE G-2 (rencana pembayaran & denda) | PASS (14s) |
...
| POC FASE G-6b (faktur pajak internal · retur antar-PT · pengingat · margin) | PASS (14s) |
| INV-GATE-01 anti-residu FASE POC (POC tak boleh menggeser stok/dokumen) | PASS (0s) |
| seed_realistic (pulihkan data demo setelah FASE POC) | PASS (17s) |
